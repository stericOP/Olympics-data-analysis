...
if user_menu == "Medal Tally":
  ...
  if selected_year == "Overall" and selected_country != "Overall":
    st.title("Overall Tally" + "- " + selected_country)
  if selected_year != "Overall" and selected_country != "Overall":
...
if user_menu == "Overall Analysis":
  ...
  st.title("Particating Nations over the years")
  st.plotly_chart(fig)

  events_over_time = helper.data_over_time(df, "Event")
  fig = px.line(events_over_time, x='Edition', y='Event')
  st.title("Events Featured over the years")
  st.plotly_chart(fig)
  ...
  selected_sport = st.selectbox("Select",sport_list)
...
if user_menu == "Country Wise Analysis":
  ...
  country_list.sort()
  selected_country = st.sidebar.selectbox("Select",country_list)
  ...
  st.title("Most Successful Atheletes- "+ selected_country)
  st.table(top10_df)
...
if user_menu == "Athlete Wise Analysis":
  ...
  x = []
  name = []
  famous_sports = sports.famous_sports
